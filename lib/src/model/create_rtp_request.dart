...
CreateRtpRequest createRtpRequestFromJson(String str) =>
    CreateRtpRequest.fromJson(json.decode(str));

String createRtpRequestToJson(CreateRtpRequest data) =>
    json.encode(data.toJson());

class CreateRtpRequest {
  CreateRtpRequest({
    this.channelId,
    this.credData,
    this.deviceInf,
  ...
  factory CreateRtpRequest.fromJson(Map<String, dynamic> json) =>
      CreateRtpRequest(
