...
TransactionsByUserResponse getTransactionsByUserResponseFromJson(
        String str) =>
    TransactionsByUserResponse.fromJson(json.decode(str));

String getTransactionsByUserResponseToJson(
        TransactionsByUserResponse data) =>
    json.encode(data.toJson());

class TransactionsByUserResponse {
  ...
  factory TransactionsByUserResponse.fromJson(Map<String, dynamic> json) =>
      TransactionsByUserResponse(
        code: json["code"],
