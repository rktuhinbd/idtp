...
RtpSentListRequest rtpSentListRequestFromJson(String str) => RtpSentListRequest.fromJson(json.decode(str));

String rtpSentListRequestToJson(RtpSentListRequest data) => json.encode(data.toJson());

class RtpSentListRequest {
  RtpSentListRequest({
    this.channelId,
    this.credData,
    this.deviceInf,
  ...
  factory RtpSentListRequest.fromJson(Map<String, dynamic> json) => RtpSentListRequest(
